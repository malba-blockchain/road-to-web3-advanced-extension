...
const Home = () => {
  ...
  const fetchNFTs = async () => {
    ...
    const NEXT_PUBLIC_ETHEREUM_API_KEY = process.env.NEXT_PUBLIC_ETHEREUM_API_KEY;
    const baseURL = `https://eth-mainnet.g.alchemy.com/v2/${NEXT_PUBLIC_ETHEREUM_API_KEY}/getNFTs/`;
  ...
  const fetchNFTsForCollection = async () => {
    if (collection.length) {
      ...
      const NEXT_PUBLIC_ETHEREUM_API_KEY = process.env.NEXT_PUBLIC_ETHEREUM_API_KEY;
      const baseURL = `https://eth-mainnet.g.alchemy.com/v2/${NEXT_PUBLIC_ETHEREUM_API_KEY}/getNFTsForCollection/`;
      const fetchURL = `${baseURL}?contractAddress=${collection}&withMetadata=${"true"}&pageKey=${"0"}`;
