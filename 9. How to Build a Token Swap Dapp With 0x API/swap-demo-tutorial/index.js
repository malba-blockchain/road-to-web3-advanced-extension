    ...
    if (typeof window.ethereum !== "undefined") {
        try {
          ...
          await window.ethereum.request({
            ...
            params: [{ chainId: '0x89' }], // '0x3830303031'
          })
        } catch (error) {
          try {
            await ethereum.request({ method: "eth_requestAccounts" });
...
//Just get the price for the swap without compromise of buying
async function getPrice(){
  ...
  const headers = {'0x-api-key': 'APIKEY GOES HERE INSIDE THE SINGLE QUOTATION MARKS'}; // This is a placeholder. Get your live API key from the 0x Dashboard (https://dashboard.0x.org/apps)
...
//Get the real quote ready to make a swap
async function getQuote(account){
    ...
    const headers = {'0x-api-key': 'cd995d56-fe3e-4cee-a6a8-ff8b755547a9'}; // This is a placeholder. Get your live API key from the 0x Dashboard (https://dashboard.0x.org/apps)
...
//Tryswap based on allowance of the user
async function trySwap(){
  ...
  console.log("allowanceTarget", swapQuoteJSON.allowanceTarget);
...
//Launch the whole website execution
init();
